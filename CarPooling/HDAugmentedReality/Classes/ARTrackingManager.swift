...
open class ARTrackingManager: NSObject, CLLocationManagerDelegate{
    ...
    open var reloadDistanceFilter: CLLocationDistance!
 ...
 */
    ...
    open func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]){
        if locations.count > 0 {
             ...
             */
            let p : CLLocationCoordinate2D = ViewController.plane.coordinate
            location = CLLocation(coordinate: p, altitude: locations[0].altitude, horizontalAccuracy: locations[0].horizontalAccuracy, verticalAccuracy: locations[0].verticalAccuracy, timestamp: locations[0].timestamp)
