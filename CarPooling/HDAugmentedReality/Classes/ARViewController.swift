...
open class ARViewController: UIViewController, ARTrackingManagerDelegate{
    ...
    func refresh(_ places : [ARAnnotation]){
        self.setAnnotations(places)
        self.trackingManager.reTracking()
    }
    ...
    func reload(calculateDistanceAndAzimuth: Bool, calculateVerticalLevels: Bool, createAnnotationViews: Bool)
    {
        //NSLog("==========")
    ...
    open class func createCaptureSession() -> (session: AVCaptureSession?, error: NSError?)
    {
        ...
        if let deviceDescoverySession = AVCaptureDeviceDiscoverySession.init(deviceTypes: [AVCaptureDeviceType.builtInWideAngleCamera],
            ...
            for captureDevice in deviceDescoverySession.devices {
    ...
    func addCloseButton()
    {
        ...
        {
                self.closeButtonImage = #imageLiteral(resourceName: "hdar_close")
        }
